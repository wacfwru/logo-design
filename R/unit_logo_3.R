...
#   tiff(file = "wacfwru_logo.tiff", height = 5.5, width = 5.5, units = "in", res = 300)
   png(file = "wacfwru_logo_3.png", height = 5.5, width = 5.5, units = "in", res = 300,
       bg = "transparent")
}
...
## add text
hh <- -3.6
mtext("WASHINGTON", side = 3, line = -3.6 + hh,
      cex = 3, adj = 0.87, col = colors$green)
par(family = "roboto")
mtext("C O O P E R A T I V E", side = 3, line = -5.6 + hh,
      cex = 2.33, adj = 0.86, col = colors$brown)
mtext("Fish and Wildlife Research Unit", side = 3, line = -7.1 + hh,
